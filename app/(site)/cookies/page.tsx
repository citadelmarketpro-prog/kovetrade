...
const THIRD_PARTIES = [
  ...
  { name: "Google Ads",        purpose: "Targeted advertising & remarketing",      icon: "Ads", color: "from-blue-500 to-cyan-500"      },
  { name: "Hotjar",            purpose: "Heatmaps & session recordings",           icon: "HJ",  color: "from-rose-500 to-pink-600"      },
  { name: "Intercom",          purpose: "Live chat & customer support",            icon: "IC",  color: "from-indigo-500 to-violet-600"  },
  { name: "Cloudflare",        purpose: "Security, fraud detection & CDN",         icon: "CF",  color: "from-amber-500 to-orange-600"   },
  { name: "Meta Pixel",        purpose: "Social advertising & conversion tracking", icon: "FB", color: "from-blue-600 to-indigo-600"    },
];
      ...
      <main className="py-16 sm:py-24 bg-gray-50 dark:bg-[#080909]">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 space-y-4">
          ...
          <AccordionSection n={2} label="Definition" title="What is a Cookie?" delay={0.04}
            ...
            borderClass="border-blue-100 dark:border-blue-500/[0.15]"
            bgClass="bg-blue-50/60 dark:bg-blue-500/[0.04]"
          ...
          >
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {[
                ...
                <div key={label} className="rounded-2xl border border-blue-100 dark:border-blue-500/[0.15] bg-blue-50/50 dark:bg-blue-500/[0.04] p-5">
                  <p className="text-[11px] font-bold text-blue-600 dark:text-blue-400 tracking-widest uppercase mb-3 flex items-center gap-2">
          ...
          <AccordionSection n={3} label="Browser Controls" title="How to Delete and Block Cookies" delay={0.06}
            ...
            borderClass="border-violet-100 dark:border-violet-500/[0.15]"
            bgClass="bg-violet-50/60 dark:bg-violet-500/[0.04]"
          ...
          >
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-5">
              {[
                { name: "Chrome",  path: "Settings → Privacy → Cookies", color: "from-blue-500 to-sky-500" },
                { name: "Firefox", path: "Settings → Privacy & Security", color: "from-orange-500 to-amber-500" },
                { name: "Safari",  path: "Preferences → Privacy",         color: "from-blue-400 to-cyan-500" },
                { name: "Edge",    path: "Settings → Cookies & data",     color: "from-teal-500 to-cyan-500" },
              ].map(({ name, path, color }) => (
              ...
              <div id="s6" className="scroll-mt-20 grid sm:grid-cols-2 divide-y sm:divide-y-0 sm:divide-x divide-gray-100 dark:divide-white/[0.06]">
                ...
                <div className="p-6 sm:p-7">
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-10 h-10 rounded-2xl bg-gradient-to-br from-sky-500 to-blue-600 flex items-center justify-center text-white shadow-lg shrink-0">
                      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                        <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" />
                      </svg>
                    </div>
                    <div>
                      <p className="text-[10px] font-bold text-sky-600 dark:text-sky-400 uppercase tracking-widest">§5 · Temporary</p>
                      <p className="text-[15px] font-black text-gray-900 dark:text-white">Session Cookies</p>
                    </div>
                  </div>
                  <div className="mb-4 flex items-center gap-2 rounded-xl bg-sky-50 dark:bg-sky-500/[0.08] border border-sky-100 dark:border-sky-500/[0.2] px-3 py-2">
                    ...
                    <span className="text-[11px] text-sky-700 dark:text-sky-400 font-semibold">Auto-deleted when browser closes</span>
                  </div>
          ...
          <AccordionSection n={7} label="External Providers" title="Third-Party Cookies" delay={0.12}
            ...
            borderClass="border-rose-100 dark:border-rose-500/[0.15]"
          ...
          <AccordionSection n={8} label="Tracking Pixels" title="Use of Web Beacons" delay={0.14}
            ...
            borderClass="border-indigo-100 dark:border-indigo-500/[0.15]"
            bgClass="bg-indigo-50/60 dark:bg-indigo-500/[0.04]"
          ...
          >
            ...
            <div className="grid sm:grid-cols-3 gap-4">
              {BEACON_USES.map(({ icon, t, b }) => (
                <div key={t} className="relative rounded-2xl border border-indigo-100 dark:border-indigo-500/[0.15] bg-indigo-50/50 dark:bg-indigo-500/[0.04] p-5 overflow-hidden">
                  <div className="absolute top-3 right-3 text-indigo-200 dark:text-indigo-900/60 text-4xl font-black select-none pointer-events-none leading-none">
                    {icon}
                  </div>
          ...
          <Reveal delay={0.18}>
            <div
              ...
              style={{ background: "linear-gradient(135deg, #0f766e 0%, #0891b2 55%, #1d4ed8 100%)" }}
            >
