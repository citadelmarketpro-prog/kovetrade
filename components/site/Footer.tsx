      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="lg:col-span-3">
            <div className="mb-4">
              <span className="text-2xl font-bold">
                Kove<span className="text-[var(--primary)]">Trade</span>
              </span>
            </div>
            <p className="mb-4 text-sm text-[var(--foreground-muted)]">
              Copytrade with KoveTrade
            </p>
        ...
        <div className="mt-8 border-t border-[var(--border)] pt-8">
          <div className="space-y-4 text-xs leading-relaxed text-[var(--foreground-muted)]">
            <p>
              Disclaimer KoveTrade (Europe) Ltd., a Financial Services Company
              ...
              Limassol, Cyprus. KoveTrade (UK) Ltd, a Financial Services
              ...
              KoveTrade (USA) Ltd, a financial company authorised and regulated
              ...
              Castlereagh Street, Sydney NSW 2000, Australia. KoveTrade (ME)
            ...
            <p>
              ...
              Under no circumstances shall KoveTrade have any liability to any
              ...
              KoveTrade by following and/or copying or replicating the trades
              ...
              performance of a KoveTrade Community Member is not a reliable
              indicator of his future performance. Content on KoveTrade&apos;s
              ...
              KoveTrade- Your Social Investment Network.
            </p>
            <p className="pt-4">
              Copyright &copy; 2006-2026 KoveTrade - Your Social Investment Network,
              All rights reserved.
            </p>
          </div>
        </div>
